...
#define  NET_ARP_CACHE_TIMEOUT_MIN_SEC             ( 1L * DEF_TIME_NBR_SEC_PER_MIN) /* Cache timeout min  =  1 minute   */
#define  NET_ARP_CACHE_TIMEOUT_MAX_SEC             (10L * DEF_TIME_NBR_SEC_PER_MIN) /* Cache timeout max  = 10 minutes  */
//start modified by xjx 2014/4/30
#define  NET_ARP_CACHE_TIMEOUT_DFLT_SEC            (20L * DEF_TIME_NBR_SEC_PER_MIN) /* Cache timeout dflt = 10 minutes  */
//end modified by xjx 2014/4/30
...
void  NetARP_Tx (CPU_INT08U  *paddr_hw_sender,
