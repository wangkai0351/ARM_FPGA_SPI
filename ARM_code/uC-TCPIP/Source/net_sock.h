...
#define  NET_SOCK_PORT_NBR_RANDOM_NBR_OFF                 30000
...
*                          & 'net_conn.h  NETWORK CONNECTION IDENTIFICATION DATA TYPE  Note #1b'.
*
...
*                   0,    otherwise.
*
*               See also 'net_bsd.h  BSD 4.x FILE DESCRIPTOR MACRO'S  Note #1a2'.
*
...
*
*                   See also 'net_bsd.h  BSD FILE DESCRIPTOR MACRO'S  Note #2'.
*********************************************************************************************************
*/
...
#error  "                                     [     &&  <= ((NET_PORT_NBR_MAX + 1) - (NET_SOCK_CFG_NBR_SOCK + NET_SOCK_PORT_NBR_RANDOM_NBR_OFF))]"
