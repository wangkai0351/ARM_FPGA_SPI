...
#define  NET_OS_ERR_INIT_TCP_RX_Q                       1400    /* TCP  rx Q's                 NOT successfully init'd. */
#define  NET_OS_ERR_INIT_TCP_RX_Q_TIMEOUT               1401    /* TCP  rx Q's         timeout NOT successfully init'd. */
#define  NET_OS_ERR_INIT_TCP_TX_Q                       1402    /* TCP  tx Q's                 NOT successfully init'd. */
#define  NET_OS_ERR_INIT_TCP_TX_Q_TIMEOUT               1403    /* TCP  tx Q's         timeout NOT successfully init'd. */

#define  NET_OS_ERR_INIT_SOCK_RX_Q                      1500    /* Sock rx Q's                 NOT successfully init'd. */
#define  NET_OS_ERR_INIT_SOCK_RX_Q_TIMEOUT              1501    /* Sock rx Q's         timeout NOT successfully init'd. */
#define  NET_OS_ERR_INIT_SOCK_CONN                      1502    /* Sock req    signal          NOT successfully init'd. */
#define  NET_OS_ERR_INIT_SOCK_CONN_TIMEOUT              1503    /* Sock req    signal  timeout NOT successfully init'd. */
#define  NET_OS_ERR_INIT_SOCK_ACCEPT                    1504    /* Sock accept signal          NOT successfully init'd. */
#define  NET_OS_ERR_INIT_SOCK_ACCEPT_TIMEOUT            1505    /* Sock accept signal  timeout NOT successfully init'd. */
#define  NET_OS_ERR_INIT_SOCK_CLOSE                     1506    /* Sock close  signal          NOT successfully init'd. */
#define  NET_OS_ERR_INIT_SOCK_CLOSE_TIMEOUT             1507    /* Sock close  signal  timeout NOT successfully init'd. */
...
#define NET_SERVER_SOCK_OPEN_ERR				41600
#define NET_SERVER_SOCK_BIND_ERR				41601
#define NET_SERVER_SOCK_LISTEN_ERR			41602
#define NET_SERVER_RX_SIZE_ERR				41603
#define NET_SERVER_SOCK_ERR_RX_Q_CLOSED		41604
#define NET_SERVER_SOCK_ACCEPT_ERR		        41605
#define TCP_SERVER_CONN_Q_SIZE			        16
