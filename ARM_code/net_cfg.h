...
#define  NET_NIC_CFG_RD_WR_SEL                  NET_NIC_RD_WR_SEL_MACRO
...
#define  NET_IF_CFG_TYPE                        NET_IF_TYPE_ETHER
                                                                ...
                                                                /* Configure Net IF address filter feature :            */
...
#define  NET_ARP_CFG_NBR_CACHE                            256    /* Configure ARP cache size.                            */
//start modified by xjx 2014/4/30 
                                                                /* Configure ARP address filter feature (see Note #3) : */
#define  NET_ARP_CFG_ADDR_FLTR_EN               DEF_DISABLED
                                                                /*   DEF_DISABLED    ARP addresses NOT filtered         */
                                                                /*   DEF_ENABLED     ARP addresses     filtered         */
//end modified by xjx 2014/4/30                                                                /* ------------------ SRCH ARP CACHE ------------------ */
...
#define  NET_TCP_CFG_NBR_CONN                             32    /* Configure total number of TCP connections.           */
...
#define  NET_SOCK_CFG_NBR_SOCK                            32    /* Configure total number of sockets.                   */
...
#define  NET_SOCK_CFG_PORT_NBR_RANDOM_BASE             15000    /* Configure random ports' starting port number.        */
...
#define  NET_CONN_CFG_NBR_CONN                            64    /* Configure total number of connections (see Note #3). */
