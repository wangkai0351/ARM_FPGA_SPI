...
*
*                   (1) 'cpu_sr' local variable SHOULD be declared via the CPU_SR_ALLOC() macro.
*
...
#define  CPU_CRITICAL_ENTER()     { cpu_sr = CPU_SR_Save(); }   /* Save    CPU status word.                             */
#define  CPU_CRITICAL_EXIT()      { CPU_SR_Restore(cpu_sr); }   /* Restore CPU status word.                             */
